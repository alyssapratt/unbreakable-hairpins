...
def make_hairpin_insertions(fasta_file):
    ...
    for record in SeqIO.parse(fasta_file,'fasta'):
        ...
        if is_valid(seq, dot_bracket):
            modified_seq = make_insertion(seq)
...
valid_modified_hairpins,invalid_modified_hairpins = make_hairpin_insertions(fasta_file)
